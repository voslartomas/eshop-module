...
class SettingsPresenter extends BasePresenter
{
    ...
    {
        $settings = array();
        $settings[] = $this->settings->get('API identificator', 'eshopModule', 'text', array());
        $settings[] = $this->settings->get('API token', 'eshopModule', 'text', array());
    ...
    {
        if ($id) {
            $this->payment = $this->paymentRepository->find($id);
        } else {
            $this->payment = new \WebCMS\EshopModule\Doctrine\Payment();
        }
    }
    ...
    {
        if ($id) {
            $this->shipping = $this->shippingRepository->find($id);
        } else {
            $this->shipping = new \WebCMS\EshopModule\Doctrine\Shipping();
        }
    }
    ...
    {
        if ($id) {
            $this->status = $this->statusRepository->find($id);
        } else {
            $this->status = new \WebCMS\EshopModule\Doctrine\OrderState();
        }
    }
